...
public class BounceCriteriaTest {
  ...
  public void testBounceDetectionWithDifferentCriteria() {
    ...
    assertEquals(1, campaignData.getTotalBounces()); // Still a bounce (1 page < 2)
    ...
    assertEquals(1, campaignData.getTotalBounces()); // Still a bounce (3 seconds < 4)
    ...
    assertEquals(0, campaignData.getTotalBounces()); // Not a bounce (3 seconds >= 3)
  ...
  public void testBounceCalculationForDateRanges() {
    ...
    assertEquals(1, campaignData.getTotalBounces());
    assertEquals(1, campaignData.getBouncesForDate(day1));
    assertEquals(0, campaignData.getBouncesForDate(day2));
    ...
    assertEquals(2, campaignData.getTotalBounces());
    assertEquals(1, campaignData.getBouncesForDate(day1));
    assertEquals(1, campaignData.getBouncesForDate(day2));
  }
  ...
  public void testUpdatingCriteria() {
    ...
    assertEquals(0, campaignData.getTotalBounces());
  }
  ...
  public void testEdgeCases() {
    ...
    BounceCriteria pagesOnlyCriteria = new BounceCriteria(2, 4, true, false);
    campaignData.setBounceCriteria(pagesOnlyCriteria);
    assertEquals(1, campaignData.getTotalBounces()); // Only considers pages
    ...
    assertEquals(0, campaignData.getTotalBounces()); // No enabled criteria = no bounces
  }
