...
import com.adauction.group19.controller.ManageSavedCampaignsController;
 ...
 */
public class ManageSavedCampaignsScreen {
    ...
    public static Scene getScene(Stage stage) {
        try {
            FXMLLoader loader = new FXMLLoader(InputDataScreen.class.getResource("/fxml/ManageSavedCampaignsScreen.fxml"));
            Parent root = loader.load();

            // Get the campaign data using the controller
            ManageSavedCampaignsController controller = loader.getController();
